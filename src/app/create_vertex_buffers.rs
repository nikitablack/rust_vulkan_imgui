...
pub fn create_vertex_buffers(
    ...
    debug_assert!(app_data.vertex_mem_buffers.is_empty());
    ...
    for i in 0..crate::NUM_RESOURCES_IN_FLIGHT {
        let mem_buffer =
            app::create_vertex_buffer(vulkan_data, 100, format!("vertex buffer {}", i))?;

        app_data.vertex_mem_buffers.push(mem_buffer);
    }
