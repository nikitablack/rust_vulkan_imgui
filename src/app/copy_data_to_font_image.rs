...
pub fn copy_data_to_image(
    ...
    let staging_mem_buffer = match app::create_buffer(
    ...
    let command_buffer = match allocate_command_buffer(device_ref, app_data.command_pool) {
        Ok(cb) => cb,
